...
if (!isAdmins) return reply(ADMIN)	
  if (args[1] == 'second') {
                ...
                setTimeout(() => {
                    ...
                    const open = `*OPEN TIME* THE GROUP WAS OPENED BY 𝐓𝐀𝐊𝐀-𝐋𝐈𝐓𝐄 TO APPROVED ADMIN\n NOW MEMBERS CAN SEND MESSAGES 🔓`
...
if (!isAdmins) return reply(ADMIN)	
                ...
                setTimeout(() => {
                    ...
                    const close = `*CLOSE TIME* GROUP CLOSED BY 𝐓𝐀𝐊𝐀-𝐋𝐈𝐓𝐄 AT APPROVED ADMIN\nNOW ONLY ADMIN CAN SEND MESSAGES 🔐`
...
if (!isBotAdmins) return reply(mg.needbotadmins);     
           ...
           const mass = await conn.sendMessage(m.chat, { text: '*GROUP CHAT MUTED BY 𝐓𝐀𝐊𝐀-𝐋𝐈𝐓𝐄* 🔒' }, { quoted: mek });
...
if (!isBotAdmins) return reply(mg.needbotadmins);     
           ...
           const mass = await conn.sendMessage(m.chat, { text: '*GROUP CHAT UNMUTED BY 𝐓𝐀𝐊𝐀-𝐋𝐈𝐓𝐄* 🔒' }, { quoted: mek });
            return await conn.sendMessage(m.chat, { react: { text: '🔒', key: mass.key } });
} catch(e) {
console.log(e);
reply('*PLEASE GIVE ME A ADDMIN ROLE❗👻*')    
