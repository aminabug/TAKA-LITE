...
console.log("CONNECTING ᴛᴀᴋᴀ-ʟɪᴛᴇ🧬...");
...
console.log('ᴛᴀᴋᴀ-ʟɪᴛᴇ CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ᴛᴀᴋᴀ-ʟɪᴛᴇ ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ ᴋɢ ᴛᴇᴄʜ✅*

> *❁ᴊᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs ᴛᴀᴋᴀ-ʟɪᴛᴇ❁*

*https://whatsapp.com/channel/0029Vark1I1AYlUR1G8YMX31*

> *❁ᴊᴏɪɴ ᴏᴜʀ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ ғᴏʀ ᴜᴘᴅᴀᴛᴇs ᴛᴀᴋᴀ-ʟɪᴛᴇ❁*

*https://youtube.com/@Diorrebero*

*╭⊱✫🐲 ᴛᴀᴋᴀ-ʟɪᴛᴇ 🐲✫⊱╮*
*│✫➠ - 📂REPOSITORY NAME:* *ᴛᴀᴋᴀ-ʟɪᴛᴇ*
*│✫➠ - 📃DESCRIPTION:* *THE WORLD BEST WHATSAPP BOT♻️*
*│✫➠ - 🛡️OWNER:* *꧁•༆$ℭ𝔥𝔯𝔦𝔰_𝔇𝔦𝔬𝔯🚹࿇꧂*
*│✫➠ - 🌐URL:* *https://github.com/Takatech85/TAKA-LITE*

*YOUR BOT ACTIVE NOW ENJOY♥️🪄*\n\n*PREFIX: ${prefix}*

*╰──────────────●●►*`;
conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/bv9qgj.jpeg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("237659079843")){
if(isReact) return
m.react("🚹")
}
...
app.get("/", (req, res) => {
res.send("HEY, ᴛᴀᴋᴀ-ʟɪᴛᴇ STARTED ✅");
});
